...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app', '0016_remove_user_tutor_mode'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='email',
            field=models.EmailField(default='example@gmail.com', max_length=254, unique=True, verbose_name='email address'),
        ...
        migrations.AddField(
            model_name='user',
            name='password',
            field=models.CharField(default='mamba', max_length=128, verbose_name='password'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='user',
